...
public class listen_succeeded_alert extends alert {
  ...
  public listen_succeeded_alert(tcp_endpoint ep, socket_type_t t) {
  ...
  public socket_type_t getSock_type() {
    return socket_type_t.swigToEnum(libtorrent_jni.listen_succeeded_alert_sock_type_get(swigCPtr, this));
  }
