...
public class torrent_checked_alert extends torrent_alert {
  ...
  public torrent_checked_alert(torrent_handle h) {
    this(libtorrent_jni.new_torrent_checked_alert(torrent_handle.getCPtr(h), h), true);
  }
  ...
  public int category() {
    return libtorrent_jni.torrent_checked_alert_category(swigCPtr, this);
  }
  ...
  public final static int static_category = libtorrent_jni.torrent_checked_alert_static_category_get();
}
