...
public class listen_failed_alert extends alert {
  ...
  public listen_failed_alert(tcp_endpoint ep, int op, error_code ec, socket_type_t t) {
  ...
  public void setSock_type(socket_type_t value) {
    libtorrent_jni.listen_failed_alert_sock_type_set(swigCPtr, this, value.swigValue());
  }

  public socket_type_t getSock_type() {
    return socket_type_t.swigToEnum(libtorrent_jni.listen_failed_alert_sock_type_get(swigCPtr, this));
  }
