...
public class torrent_added_alert extends torrent_alert {
  private long swigCPtr;

  protected torrent_added_alert(long cPtr, boolean cMemoryOwn) {
    super(libtorrent_jni.torrent_added_alert_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }

  protected static long getCPtr(torrent_added_alert obj) {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        libtorrent_jni.delete_torrent_added_alert(swigCPtr);
      }
      swigCPtr = 0;
    }
    super.delete();
