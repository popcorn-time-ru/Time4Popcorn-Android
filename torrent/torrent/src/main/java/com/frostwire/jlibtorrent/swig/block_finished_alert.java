...
public class block_finished_alert extends peer_alert {
  ...
  public block_finished_alert(torrent_handle h, tcp_endpoint ep, sha1_hash peer_id, int block_num, int piece_num) {
    this(libtorrent_jni.new_block_finished_alert(torrent_handle.getCPtr(h), h, tcp_endpoint.getCPtr(ep), ep, sha1_hash.getCPtr(peer_id), peer_id, block_num, piece_num), true);
  }
  ...
  public int category() {
    return libtorrent_jni.block_finished_alert_category(swigCPtr, this);
  }
  ...
  public final static int static_category = libtorrent_jni.block_finished_alert_static_category_get();
}
