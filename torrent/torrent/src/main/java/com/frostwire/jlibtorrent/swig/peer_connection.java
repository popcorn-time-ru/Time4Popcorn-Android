...
public class peer_connection extends bandwidth_socket {
  ...
  public peer_speed_t peer_speed() {
    return peer_speed_t.swigToEnum(libtorrent_jni.peer_connection_peer_speed(swigCPtr, this));
  }
  ...
  public void setup_receive(sync_t sync) {
