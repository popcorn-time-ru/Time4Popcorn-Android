...
public class CastDiscoveryProvider implements DiscoveryProvider {
    ...
    private class MediaRouterCallback extends MediaRouter.Callback {
        /*
             added to solve issue with add/changed event mess.
         */
        private void onRouteChangedInt(MediaRouter router, RouteInfo route) {
        ...
        public void onRouteAdded(MediaRouter router, RouteInfo route) {
            ...
            Log.d(Util.T, "onRouteAdded: [" + route.getName() + "] ["
                    + route.getDescription() + "]");

            super.onRouteAdded(router, route);

            //added to solve issue with add/changed event mess.
            this.onRouteChangedInt(router, route);
            /*
            CastDevice castDevice = CastDevice.getFromBundle(route.getExtras());
            String uuid = castDevice.getDeviceId();
        ...
        public void onRouteChanged(MediaRouter router, RouteInfo route) {
            ...
            Log.d(Util.T, "onRouteChanged: [" + route.getName() + "] ["
                    + route.getDescription() + "]");
        ...
        public void onRouteRemoved(final MediaRouter router, final RouteInfo route) {
            Log.d(Util.T, "onRouteRemoved: [" + route.getName() + "] ["
                    + route.getDescription() + "]");
